...
<body class="d-flex flex-column h-100 text-center text-white" style="background-color:   #002366;">
    <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
      ...
      <main class="px-3">
        ...
        <a href="https://github.com/geovannadama/cadastro_login" class="btn btn-primary">GitHub</a>
      </main>

      <footer class="mt-auto text-white-50" style="background-color:  #002366; padding: 20px;">
